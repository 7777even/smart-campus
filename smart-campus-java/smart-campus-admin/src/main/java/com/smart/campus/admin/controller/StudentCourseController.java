...
import com.smart.campus.admin.biz.StudentCourseAdminBiz;
...
public class StudentCourseController {
    ...
    private final StudentCourseAdminBiz studentCourseAdminBiz;

    public StudentCourseController(StudentCourseServiceImpl studentCourseService,
                                   StudentCourseAdminBiz studentCourseAdminBiz) {
        this.studentCourseService = studentCourseService;
        this.studentCourseAdminBiz = studentCourseAdminBiz;
    }
    ...
    public R<Void> enroll(@RequestAttribute(required = false) Long studentId,
        ...
        studentCourseService.enroll(StudentCourseAdminBiz.requireStudentId(studentId), courseId);
        return R.ok();
    }
    ...
    public R<Void> drop(@RequestAttribute(required = false) Long studentId,
        ...
        studentCourseService.drop(StudentCourseAdminBiz.requireStudentId(studentId), courseId);
        return R.ok();
    }
    ...
    public R<List<Course>> myCourses(@RequestAttribute(required = false) Long studentId) {
        List<Course> courses = studentCourseService.getMyCourses(StudentCourseAdminBiz.requireStudentId(studentId));
        return R.ok(courses);
    }
    ...
    public R<Boolean> check(@RequestAttribute(required = false) Long studentId,
                            @PathVariable Long courseId) {
        boolean enrolled = studentCourseService.isEnrolled(StudentCourseAdminBiz.requireStudentId(studentId), courseId);
    ...
    public R<Long> count(@RequestAttribute(required = false) Long studentId) {
        long count = studentCourseService.countByStudentId(StudentCourseAdminBiz.requireStudentId(studentId));
        return R.ok(count);
    }
}
